...
- Java (version to be specified)
- IntelliJ IDEA (recommended version to be specified)
- Gradle
- Git
...
bash
git clone https://github.com/Advanse-Lab/xtract-plugin-intellij.git
cd xtract-plugin-intellij
...
2. Allow Gradle to import the project dependencies.
3. Wait until indexing is complete.
4. Run the IntelliJ Plugin configuration (typically *Run Plugin* or *runIde*).
5. A new IntelliJ IDEA instance will be launched with the Xtract plugin installed.
...
2. Select the method to be analyzed.
3. Right-click on the selected method.
4. Choose *Analysis for Refactoring Opportunities*.
5. Select *Extract Method*.
6. Review the recommendation generated by Xtract.
---
